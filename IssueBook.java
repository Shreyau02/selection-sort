...
public class Demosingleresponsibilty{
	public static void main(String args[])
	{
		Student sony=new Student();
		sony.getName("sony mathew");
		sony.getregisterno("119CS2001");
...
class Issuebook{
		...
		public void issuebook()
		{
			...
			System.out.println("with the request id as"+this.rb.getrequestID()+"bieng issused to"+this.rb.getStudent().getName());
